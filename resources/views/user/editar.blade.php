...
@section('content')
    ...
    <div class="card border-info">
        ...
        <div class="card-header border-info"><h2>Editar Usuario</h2></div>

        <div class="card-body">

            <form method="POST" action="{{ url('/EditarUsuario/'.$user->rut) }}">
                {{ method_field('PUT') }}
                @csrf
            ...
            <a href="{{ url('/Usuarios') }}"><button type="submit" class="btn btn-primary" style="width: 130px;">Volver</button></a></br></br>
