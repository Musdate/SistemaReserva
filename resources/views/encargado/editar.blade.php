...
@section('content')
    ...
    <div class="card border-info">
        ...
        <div class="card-header border-info"><h2>Editar Encargado</h2></div>

        <div class="card-body">

            <form method="POST" action="{{ url('/EditarEncargado/'.$user->rut) }}">
                {{ method_field('PUT') }}
                @csrf
            ...
            <a href="{{ url('/Encargados') }}"><button type="submit" class="btn btn-primary" style="width: 130px;">Volver</button></a></br></br>
