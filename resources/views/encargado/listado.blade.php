                ...
                @if($user->tipoUsuarioID == '1')
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Boton Eliminar -->
                            <a title="Borrar" href="{{ route('encargado.delete.route', $user->rut) }}" title="delete" class="delete" onclick="
                                return confirm('ESTA SEGURO QUE DESEA ELIMINAR ESTE ENCARGADO?')">
