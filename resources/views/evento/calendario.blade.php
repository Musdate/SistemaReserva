...
@section('content')
          ...
          @if  ($dayweek['mes']==$mes)
            <div class="col box-day">
              ...
              @foreach  ($dayweek['evento'] as $event)
                @if ($event->estado == 0)
                  <a class="badge badge-warning" href="{{ asset('/Evento/details/') }}/{{ $event->id }}">
                @else
  ...
  <div class="container">
      ...
      <a href="{{ asset('/AgregarReserva') }}"><button type="submit" class="btn btn-outline-danger">Crear una reserva</button></a><hr>
