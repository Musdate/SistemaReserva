                ...
                @if($user->tipoUsuarioID == '0')
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            <!-- Boton Editar -->
                            <a href="{{ route('admin.details.route', $user->rut) }}">
                            ...
                            <!-- Boton Eliminar -->
                            <a href="{{ route('admin.delete.route', $user->rut) }}" class="delete"
                            onclick="return confirm('¿Está seguro que desea ELIMINAR este Admin?')">
