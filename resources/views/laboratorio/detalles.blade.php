...
@section('content')
    ...
    </br><h1 style="text-align: center;">Horario {{ $lab->nombreSala }}</h1>
    ...
    </br><a href="{{ url('/Laboratorios') }}"><button type="submit" class="btn btn-primary" style="width: 130px;">Volver</button></a>
