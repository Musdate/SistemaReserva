            ...
            @foreach ($labs as $lab)
                <tr>
                    ...
                    <td style="text-align: center;">
                        <a href="{{ route('laboratorio.show.route', $lab->codigoLab) }}">
                            <button type="submit" class="btn btn-primary">
                                <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-search" fill="black" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M10.442 10.442a1 1 0 0 1 1.415 0l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1 1 0 0 1 0-1.415z"/>
                                    <path fill-rule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
                                </svg>
                            </button>
                        ...
                        @if ( Auth::user()->tipoUsuarioID == '0' ) <!-- Acciones para el Admin -->
                            <a href="{{ route('laboratorio.details.route', $lab->codigoLab) }}">
                                <button type="submit" class="btn btn-info">
                                    <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-pencil" fill="black" xmlns="http://www.w3.org/2000/svg">
                            ...
                            onclick="return confirm('¿Está seguro que desea ELIMINAR este Laboratorio?')">
                                <button type="button" class="btn btn-danger">
                                    <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-trash" fill="black" xmlns="http://www.w3.org/2000/svg">
